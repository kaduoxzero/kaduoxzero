...
<div align="center">
  <h2>
    <img src="https://capsule-render.vercel.app/api?type=transparent&color=000000&text=%F0%9F%91%A8%E2%80%8D%F0%9F%92%BB+About+Me&fontSize=30&height=55&animation=fadeIn&fontColor=000000" />
  </h2>
</div>
...
**Focus Areas:**
- 锟?High-concurrency system design
- 馃敟 Microservices & distributed architecture
- 馃 Seckill / flash-sale optimization
- 馃洝锟?Risk control & AI-powered decisions

**Current Focus:** SpikeGuard 锟?Seckill E-Commerce Platform & SemiRisk AI Risk Engine

**Fun Fact:** 锟?I debug with coffee and deploy with confidence.
...
<div align="center">
  <h2>
    <img src="https://capsule-render.vercel.app/api?type=transparent&color=000000&text=%F0%9F%9B%A0%EF%B8%8F+Tech+Stack&fontSize=30&height=55&animation=fadeIn&fontColor=000000" />
  </h2>
</div>
...
**馃搳 Detailed Tech Stack**

| Domain | Core Technologies |
|--------|-------------------|
| **Backend** | Java 21 路 Spring Boot 3 路 Spring Cloud Alibaba 路 Spring Security 路 MyBatis-Plus 路 JWT / RBAC |
| **Middleware** | PostgreSQL 路 MySQL 路 Redis 路 RabbitMQ 路 Elasticsearch 路 MinIO 路 Nacos 路 Sentinel 路 Seata |
| **Frontend** | Vue 3 路 Vite 路 Element Plus 路 Vant 路 ECharts 路 Three.js 路 Axios |
| **DevOps & AI** | Docker 路 GitHub Actions 路 Prometheus 路 Grafana 路 Zipkin 路 Kibana 路 DeepSeek API 路 Spring AI 路 RAG |
...
<div align="center">
  <h2>
    <img src="https://capsule-render.vercel.app/api?type=transparent&color=000000&text=%F0%9F%93%8A+GitHub+Statistics&fontSize=30&height=55&animation=fadeIn&fontColor=000000" />
  </h2>
</div>
...
<div align="center">
  <h2>
    <img src="https://capsule-render.vercel.app/api?type=transparent&color=000000&text=%F0%9F%9A%80+Featured+Projects&fontSize=30&height=55&animation=fadeIn&fontColor=000000" />
  </h2>
</div>
...
<table align="center">
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">馃洝锟?SpikeGuard</h3>
      <p align="center">
      ...
      <p align="center">
        ...
        <em>Gateway 路 Seckill 路 Order 路 Risk 路 Payment 路 Frontend</em><br/>
        <code>Java 21</code> <code>Spring Cloud</code> <code>Redis</code> <code>RabbitMQ</code> <code>Vue 3</code>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3 align="center">馃 SemiRisk AI</h3>
      <p align="center">
        <a href="https://github.com/kaduoxzero/SpikeGuard">
      ...
      <p align="center">
        ...
        <em>FastAPI 路 LangGraph 路 DeepSeek 路 RAG 路 Rule Engine</em><br/>
...
<div align="center">
  <h2>
    <img src="https://capsule-render.vercel.app/api?type=transparent&color=000000&text=%F0%9F%90%8D+Contribution+Graph&fontSize=30&height=55&animation=fadeIn&fontColor=000000" />
  </h2>
</div>

<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=kaduoxzero&theme=outrun&hide_border=true&border_radius=10&area=true" alt="activity-graph"/>
</div>


### 馃實 3D Contribution Calendar
