...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=230&section=header&text=kaduoxzero&fontSize=56&fontAlignY=36&desc=Java%20Backend%20%7C%20Full%20Stack%20%7C%20Microservices%20%7C%20AI%20Engineering&descSize=18&descAlignY=58&animation=fadeIn&color=0:0D1117,45:1F6FEB,100:8A2BE2&fontColor=FFFFFF" alt="kaduoxzero profile header" />

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=2600&pause=900&color=58A6FF&center=true&vCenter=true&width=900&lines=Spring+Boot+%2B+Vue+3+Project+Practice;Microservices+Architecture+%2B+Middleware+Integration;AI+Engineering+%2B+RAG+%2B+Agent+Workflow;Keep+building.+Keep+shipping." alt="typing svg" />
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>面向供应链风险管理的 <strong>AI 智能监测平台</strong>，围绕公开风险信号、供应商数据、风险事件、预警中心和 AI 报告生成组织业务闭环。</p>
      <ul>
        <li>数据采集、风险识别、智能分析、告警/报告闭环。</li>
        <li>企业画像、GIS 地图、知识库问答、风险详情下钻。</li>
        <li>DeepSeek API / Spring AI 用于风险摘要、报告撰写和问答。</li>
      </ul>
      <p><strong>技术：</strong>Java 21、Spring Boot 3.5、Spring Cloud Alibaba、Vue 3、Three.js、MySQL、Redis、Elasticsearch、MinIO、RabbitMQ、Nacos、Docker。</p>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>技术栈聚焦</h3>
      <p><strong>后端：</strong>Java、Spring Boot、Spring Cloud Alibaba、Spring Security、MyBatis / MyBatis-Plus</p>
      <p><strong>前端：</strong>Vue 3、Vite、Element Plus、ECharts、Axios、Vue Router</p>
      <p><strong>中间件：</strong>MySQL、Redis、Elasticsearch、RabbitMQ、MinIO、Nacos</p>
      <p><strong>工程化：</strong>Maven、Docker、Docker Compose、Git、GitHub Actions</p>
      <p><strong>AI 应用：</strong>DeepSeek API、Spring AI、RAG、AI 报告生成、Agent 流程设计</p>
    </td>
  </tr>
</table>
...
<div align="center">
  <picture>
    ...
    <img width="100%" alt="Star History Chart" src="https://api.star-history.com/svg?repos=kaduoxzero/SemiRisk,kaduoxzero/WebAI-Tlias,kaduoxzero/YunLanHome&type=Date" />
  </picture>
</div>
